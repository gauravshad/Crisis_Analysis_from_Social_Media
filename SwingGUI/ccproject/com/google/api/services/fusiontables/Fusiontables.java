...
public class Fusiontables extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.22.0 of the Fusion Tables API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Table {
    ...
    public class ReplaceRows extends FusiontablesRequest<com.google.api.services.fusiontables.model.Task> {
      ...
      protected ReplaceRows(java.lang.String tableId) {
        super(Fusiontables.this, "POST", REST_PATH, null, com.google.api.services.fusiontables.model.Task.class);
        this.tableId = com.google.api.client.util.Preconditions.checkNotNull(tableId, "Required parameter tableId must be specified.");
      }
      ...
      protected ReplaceRows(java.lang.String tableId, com.google.api.client.http.AbstractInputStreamContent mediaContent) {
        super(Fusiontables.this, "POST", "/upload/" + getServicePath() + REST_PATH, null, com.google.api.services.fusiontables.model.Task.class);
        this.tableId = com.google.api.client.util.Preconditions.checkNotNull(tableId, "Required parameter tableId must be specified.");
        initializeMediaUpload(mediaContent);
      }
